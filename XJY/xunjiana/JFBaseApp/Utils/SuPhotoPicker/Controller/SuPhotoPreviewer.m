...
- (void)setupUI {
    ...
    if (self.navigationController.viewControllers.count < 2) {
        UIBarButtonItem * backItem = [[UIBarButtonItem alloc] initWithCustomView:[UIButton buttonWithFrame:CGRectMake(0, 0, 22, 22) Target:self Selector:@selector(dismissPreviewer) Image:@"blackback" ImagePressed:@"blackback"]];
