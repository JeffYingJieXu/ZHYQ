...
// home indicator
//#define bottom_height (kIs_iPhoneX ? 34.f : 0.f)
...
-(void)setupUI {
    ...
    self.frame=CGRectMake(0, KScreenHeight-180-bottom_height, kScreenWidth, 180+bottom_height);
...
-(void)addLabelWithName:(NSArray *)nameArr {
    ...
    if (!_dateLabelColor) {
        _dateLabelColor = KRGB_COLOR(@"#ED6F21", 0.6) ;
    }
...
-(void)setCancelBtnColor:(UIColor *)cancelBtnColor {
    ...
    self.cancelBtn.backgroundColor = cancelBtnColor;
}
